 ...
 *
 * For more information on some fields see:
...
/*
 * For information about shader signatures see:
 *    http://msdn.microsoft.com/en-us/library/ff541746%28v=VS.85%29.aspx
 */
typedef
#include "vmware_pack_begin.h"
struct SVGA3dSignatureEntry {
   uint8 systemValue;         /* D3D10_SB_NAME, 8 bits would suffice */
   uint8 reg;                 /* register is a reserved word */
   uint16 mask;
   uint8 registerComponentType; /* D3D11_1DDIARG_SIGNATURE_ENTRY */
   uint8 minPrecision;          /* D3D11_1DDIARG_SIGNATURE_ENTRY */
   uint16 pad0;
}
#include "vmware_pack_end.h"
...
struct SVGACOTableDXShaderEntry {
   ...
   /* See also: D3D11_1DDIARG_TESSELLATION_IO_SIGNATURES */
